...
const Hero = ({ hero }) => {
    ...
    console.log(hero)
    return (
        <div className="min-h-screen hero" style={{ backgroundImage: 'url('+hero.imgurl+')' }}>  
                    ...
                    <div className="lg:grid lg:grid-cols-3  px-2 sm:px-12 lg:px-32">
                        <div className="col-span-2">
                            ...
                            <div data-aos="flip-down"  initial={{ rotateX: -90 }} animate={{ rotateX: 0 }} transition={{ duration: 0.5 }} className="mt-16">
                                <a href="#bookacall" className="rounded-full bg-primary px-4 py-4 mr-4 font-bold text-lg hover:opacity-80  transition-all duration-500"> 
                                { hero.buttonleft }
                                 </a>
                                <a href="#client-words" className="rounded-full  border-primary border-2 px-4 py-4 mr-2 font-bold text-lg hover:bg-primary transition-all duration-500"> 
                                { hero.buttonright }
                                </a>
                            </div>
                        </div>
